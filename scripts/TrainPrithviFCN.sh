#!/bin/bash
#SBATCH --job-name=p29_train_fcn      # Name of the job in the queue
...
# --- 3. Execute training ---
echo "Starting Python execution for Prithvi + FCN decoder..."
...
SPLIT="data/splits/seed_42/split_001pct.json"

python -u scripts/train.py \
    --config configs/prithvi_fcn_linear_probe.yaml \
    --split_json "$SPLIT"
