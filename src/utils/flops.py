...
def get_model_training_gflops(model, adaptation_strategy: str, input_size=(1, 6, 512, 512)):
    ...
    elif adaptation_strategy in ("lora", "vpt", "vpt_shallow", "vpt_deep"):
        # PEFT (LoRA / VPT): Encoder weights frozen, but activations backpropagated to reach adapters/prompts.
